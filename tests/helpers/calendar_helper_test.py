...
def test_time_addition_helpers():
    # simple case
    start_date = dt.datetime(year=2020, month=1, day=30)
    ...
    assert flip_sign.helpers.add_months(start_date, 1) == \
        dt.datetime(year=2020, month=2, day=29)

    # every year august -> november case
    start_date = dt.datetime(year=2020, month=8, day=31)
    assert flip_sign.helpers.add_months(start_date, 3) == \
        dt.datetime(year=2020, month=11, day=30)

    # simple add years
    start_date = dt.datetime(year=2020, month=6, day=29)
    assert flip_sign.helpers.add_years(start_date, 1) == \
        dt.datetime(year=2021, month=6, day=29)

    # leap year add years
    start_date = dt.datetime(year=2020, month=2, day=29)
    assert flip_sign.helpers.add_years(start_date, 1) == \
        dt.datetime(year=2021, month=2, day=28)
...
def test_simple_time_deltas(mock_datetime):
    ...
    test_date_01 = dt.datetime(year=2022, month=1, day=30, hour=13, minute=10)
    ...
    test_date_02 = dt.datetime(year=2022, month=2, day=15)
    ...
    # test a non-all-day event in the near future
    test_date_05 = dt.datetime(year=2022, month=1, day=29, hour=21, minute=13)
    ...
    test_date_06 = dt.datetime(year=2022, month=12, day=2)
...
def test_human_feel_time_deltas(mock_datetime):
    ...
    test_date_01b = dt.datetime(year=2022, month=4, day=30)
    ...
    test_date_02b = dt.datetime(year=2022, month=4, day=25)
...
def test_tricky_time_deltas(mock_datetime):
    ...
    test_date_01c = dt.datetime(year=2022, month=3, day=5)
...
def test_time_delta_errors(mock_datetime):
    ...
    test_date_01d = dt.datetime(year=2022, month=2, day=15)
    ...
    test_date_02d = dt.datetime(year=2045, month=2, day=15)
    with pytest.raises(ValueError) as e_info:
    ...
    test_date_03d = dt.datetime(year=1999, month=12, day=31)
    with pytest.raises(ValueError) as e_info:
