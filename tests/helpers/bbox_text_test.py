...
def test_bbox_text_no_truncation():
    ...
    font_1 = ImageFont.truetype(press_start_path, size=8, layout_engine=ImageFont.LAYOUT_BASIC)
    ...
    font_2 = ImageFont.truetype(press_start_path, size=14, layout_engine=ImageFont.LAYOUT_BASIC)
    assert flip_sign.helpers.bbox_text_no_truncation(bbox_size=full_sign_size, line_spacing=1, text=text,
    ...
    text = 'Rio'
    font_3 = ImageFont.truetype(press_start_path, size=16, layout_engine=ImageFont.LAYOUT_BASIC)
    answer = (True, ['Rio'])
    ...
    font_4 = ImageFont.truetype(dat_dot_path, size=7, layout_engine=ImageFont.LAYOUT_BASIC)
    answer = (True, ['Boulder'])
    assert flip_sign.helpers.bbox_text_no_truncation(bbox_size=weather_stub_size, line_spacing=1, text=text,
    ...
    font_5 = ImageFont.truetype(press_start_path, size=9, layout_engine=ImageFont.LAYOUT_BASIC)
...
def test_check_bbox_no_wrap():
    ...
    answer = (True, text)
    font_1 = ImageFont.truetype(dat_dot_path, size=8, layout_engine=ImageFont.LAYOUT_BASIC)
